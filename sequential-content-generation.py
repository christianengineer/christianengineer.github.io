...
def generate_responses(repository_name):
    ...
    prompts = [
        ...
        f"Please analyze the project's objectives, the types of data involved, and the tools being used. Based on this analysis, define the data variables that accurately reflect their roles within the system. Ensure that these variables not only enhance the interpretability of the data and the machine learning model but also contribute to its performance. Could you list all the variables that would be best suited for this purpose, including recommendations on how they should be named to achieve these objectives?",
