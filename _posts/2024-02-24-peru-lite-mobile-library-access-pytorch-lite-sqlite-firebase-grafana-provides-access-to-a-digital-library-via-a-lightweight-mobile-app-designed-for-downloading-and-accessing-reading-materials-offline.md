...
1. **Student User**
   ...
   - _User Story_: As a student, I want to access e-books and research materials from the digital library to support my studies.
   - _Associated File_: `student_user.py`

2. **Researcher User**

   - _User Story_: As a researcher, I need to download academic papers and journals for my research work even when offline.
   - _Associated File_: `researcher_user.py`

3. **Casual Reader User**

   - _User Story_: As a casual reader, I enjoy accessing a variety of novels and magazines to read during my free time.
   - _Associated File_: `casual_reader_user.py`

4. **Library Admin User**
   - _User Story_: As a library administrator, I want to manage the digital library by adding new materials, updating existing ones, and monitoring user activity.
   - _Associated File_: `library_admin_user.py`
