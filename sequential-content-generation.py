...
def generate_responses(repository_name):
    ...
    prompts = [
        ...
        f"Analyze the cleansing data strategy step by step, identify a problem that may happen, and links to the documentation of the tools",
        ...
        f"Expand on the tools that will be used for the data modeling strategy, their benefit to the project, and include links to their documentation",
        ...
        f"Generate a step by step plan to deploy this model and links to the tools mentioned",
