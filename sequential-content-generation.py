...
def generate_responses(repository_name):
    ...
    prompts = [
        f"Analyze the machine learning {repository_name} repository. Clarify objectives and benefits. Specific data types. Sourcing, cleansing, modeling and deploying strategies. Links to all tools and libraries",
        f"To optimize the development and effectiveness of the project, a detailed analysis of the datasets' data types is essential. This analysis will guide the selection and naming of variables critical to the project's success. Please provide: An analysis of the data types present in our data datasets. A comprehensive list of recommended data variables to be extracted from these datasets, tailored to the project's goals. Suggestions for variable names that accurately reflect each variable's role within the project, aiming to enhance both the interpretability of the data and the performance of the machine learning model. This request seeks to ensure that our data handling is as effective and efficient as possible, laying a solid foundation for model development and deployment.",
        f"Could you recommend specific tools or methods that are well-suited for efficiently gathering this data for the project? Additionally, how can these tools integrate within our existing technology stack to streamline the data collection process, ensuring the data is readily accessible and in the correct format for analysis and model training?",
        f"Could you outline the specific problems that might arise with this data? Furthermore, how can data cleansing practices be strategically employed to solve these issues, ensuring our data remains robust, reliable, and conducive to high-performing machine learning models? Please provide insights that are directly relevant to the unique demands and characteristics of our project, rather than general data cleansing benefits.",
        f"Generate the production-ready code required for cleansing the data",
        f"With the foundational aspects of our project now laid out, including the identification of key data variables, selection of data collection tools, and a proactive approach to data cleansing, we are poised to develop a comprehensive modeling strategy. This strategy must adeptly handle the complexities of the project's objectives and benefits accurately. Could you recommend a modeling strategy that is particularly suited to the unique challenges and data types presented by our project? Additionally, please emphasize the most crucial step within this recommended strategy, explaining why it is particularly vital for the success of our project. This step should address the intricacies of working with our specific types of data and the overarching goal of the project.",
