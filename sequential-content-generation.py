...
def generate_responses(repository_name):
    ...
    prompts = [
        ...
        f"Please analyze the types of data involved. Based on this analysis, what variables would fit best to accurately reflect their role and enhance the interpretability and performance of the machine learning model?"
