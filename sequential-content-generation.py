...
def generate_responses(repository_name):
    ...
    prompts = [
        f"Analyze the machine learning solution for: {repository_name}. Pinpoint objectives and benefits to a specific audience. Specific machine learning algorithm. Sourcing, preprocessing, modeling and deploying strategies. Links to all tools and libraries",
